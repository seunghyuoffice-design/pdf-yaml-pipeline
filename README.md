...
- **PDF Parsing**: High-quality PDF text extraction using [Docling](https://github.com/DS4SD/docling)
...
4. Docling parses PDF structure (GPU-accelerated)
...
- [Docling](https://github.com/DS4SD/docling) - PDF parsing engine
