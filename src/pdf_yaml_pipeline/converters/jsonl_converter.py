...
_META_EXCLUDE_OPENAI = ("instruction", "input", "output", "messages")
_META_EXCLUDE_ALPACA = ("instruction", "input", "output")
_META_EXCLUDE_SHAREGPT = ("instruction", "input", "output", "conversations")
_META_EXCLUDE_QWEN3 = ("instruction", "input", "output", "messages", "type")
...
class JSONLConverter:
    ...
    def _to_openai(self, data: dict) -> dict:
        ...
        return to_openai(
            ...
            exclude_keys=_META_EXCLUDE_OPENAI,
            meta_key="_meta",
    ...
    def _to_alpaca(self, data: dict) -> dict:
        ...
        return to_alpaca(
            data,
            include_metadata=self.include_metadata,
            exclude_keys=_META_EXCLUDE_ALPACA,
            meta_key="_meta",
            allow_empty_meta=True,
        )
    ...
    def _to_sharegpt(self, data: dict) -> dict:
        ...
        return to_sharegpt(
            data,
            include_metadata=self.include_metadata,
            exclude_keys=_META_EXCLUDE_SHAREGPT,
            meta_key="_meta",
            allow_empty_meta=True,
        )
    ...
    def _to_qwen3(self, data: dict) -> dict:
        ...
        return to_qwen3(
            data,
            include_metadata=self.include_metadata,
            exclude_keys=_META_EXCLUDE_QWEN3,
            meta_key="metadata",
            allow_empty_meta=True,
        )
