...
def test_validate_pdf_header():
    ...
    from pdf_yaml_pipeline.parsers.pdf_validator import validate_pdf_header
...
def test_validate_pdf_size():
    ...
    from pdf_yaml_pipeline.parsers.pdf_validator import validate_pdf_size
...
def test_validate_pdf_integrity():
    ...
    from pdf_yaml_pipeline.parsers.pdf_validator import validate_pdf_integrity
...
class TestMultiParserSystem:
    ...
    def test_initialization(self):
        ...
        from pdf_yaml_pipeline.parsers.multi_parser import MultiParserSystem

        system = MultiParserSystem(parsers=[("dummy", lambda _: {})])
    ...
    @patch('pdf_yaml_pipeline.parsers.multi_parser.logger')
...
class TestSafeParserIntegration:
    ...
    @patch('pdf_yaml_pipeline.parsers.safe_parser._parse_worker_loop')
